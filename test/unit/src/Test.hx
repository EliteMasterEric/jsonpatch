...
class Test
{
	...
	public static function assert(condition:Bool, ?message:String, ?posInfos:haxe.PosInfos):Void
	{
		if (message == null)
	 ...
	 */
	public static function assertError(func:() -> Void, ?expected:Dynamic, ?message:String, ?posInfos:haxe.PosInfos):Void
	{
		try
		{
			func();
